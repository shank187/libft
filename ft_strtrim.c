...
/*   Updated: 2024/11/23 17:01:54 by aelbour          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static int	is_valid(const char c, const char *s)
{
	size_t	i;
...
static size_t	get_trimed_len(char const *s1, char const *set, size_t *start)
{
	size_t	len;
	size_t	i;
